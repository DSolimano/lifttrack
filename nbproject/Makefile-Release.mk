...
${OBJECTDIR}/Data/Exercise.o: Data/Exercise.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Data/Exercise.o Data/Exercise.cpp

${OBJECTDIR}/Data/WorkoutSet.o: Data/WorkoutSet.cpp 
	${MKDIR} -p ${OBJECTDIR}/Data
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Data/WorkoutSet.o Data/WorkoutSet.cpp
...
${TESTDIR}/tests/ExerciseTest.o: tests/ExerciseTest.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/ExerciseTest.o tests/ExerciseTest.cpp


${TESTDIR}/tests/exerciseTestRunner.o: tests/exerciseTestRunner.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/exerciseTestRunner.o tests/exerciseTestRunner.cpp


${TESTDIR}/tests/WorkoutSetTest.o: tests/WorkoutSetTest.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I. `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/WorkoutSetTest.o tests/WorkoutSetTest.cpp


${TESTDIR}/tests/workoutSetTestRunner.o: tests/workoutSetTestRunner.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I. `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/workoutSetTestRunner.o tests/workoutSetTestRunner.cpp
...
${OBJECTDIR}/Data/Exercise_nomain.o: ${OBJECTDIR}/Data/Exercise.o Data/Exercise.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Data/Exercise_nomain.o Data/Exercise.cpp;\
	else  \
...
${OBJECTDIR}/Data/WorkoutSet_nomain.o: ${OBJECTDIR}/Data/WorkoutSet.o Data/WorkoutSet.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Data/WorkoutSet_nomain.o Data/WorkoutSet.cpp;\
	else  \
